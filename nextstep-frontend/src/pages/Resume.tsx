    ...
    <Box sx={{ p: 3 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <UploadBox onClick={handleUploadClick}>
          {fileName ? <Typography>{fileName}</Typography> : <Typography>Click to upload your resume</Typography>}
        </UploadBox>
      ...
      <Box sx={{ display: "flex", justifyContent: "center", mb: 3 }}>
        <Button variant="contained" onClick={handleSubmit} disabled={loading || !fileName}>
