...
import { scoreResume, streamScoreResume, getResumeTemplates, streamGenerateImprovedResume, parseResumeFields } from '../services/resume_service';
...
const generateResume = async (req: Request, res: Response) => {
    try {
        ...
        const result = await streamGenerateImprovedResume(feedback, jobDescription);
